import"./DsnmJJEf.js";import{t as i5,z as E5,P as T5,aA as H5,b8 as e3,U as P5,V as i3,ag as o3,b9 as l3,ba as w3,bb as A5,A as g3,bc as r3,bd as h3,be as a3,B as f5,bf as F3,au as d3,bg as p3,bh as x3,g as f3,m as G5,bi as k3,bj as v3,bk as c3,aF as M3,I as _3,aL as $,b4 as z5,ap as k5,p as D5,L as N,J as m3,f as n5,a as G,b as B5,i as S5,h as I,d as C,r as R,c as S,aq as l5,l as u3,aM as C5,ar as H,b7 as y3,s as E,K as t5,n as R5}from"./Ch07M8P7.js";import{p as v,i as b,b as b3}from"./BZfq_pgW.js";import{b as K,d as E3}from"./rEk7OFDx.js";function T3(L,t,n=!1,s=!1,e=!1){var i=L,l="";i5(()=>{var a=H5;if(l===(l=t()??"")){E5&&T5();return}if(a.nodes!==null&&(e3(a.nodes.start,a.nodes.end),a.nodes=null),l!==""){if(E5){P5.data;for(var F=T5(),w=F;F!==null&&(F.nodeType!==i3||F.data!=="");)w=F,F=o3(F);if(F===null)throw l3(),w3;A5(P5,w),i=g3(F);return}var c=n?h3:s?a3:void 0,f=r3(n?"svg":s?"math":"template",c);f.innerHTML=l;var d=n||s?f:f.content;if(A5(f5(d),d.lastChild),n||s)for(;f5(d);)i.before(f5(d));else i.before(d)}})}const P3=()=>performance.now(),q={tick:L=>requestAnimationFrame(L),now:()=>P3(),tasks:new Set};function U5(){const L=q.now();q.tasks.forEach(t=>{t.c(L)||(q.tasks.delete(t),t.f())}),q.tasks.size!==0&&q.tick(U5)}function A3(L){let t;return q.tasks.size===0&&q.tick(U5),{promise:new Promise(n=>{q.tasks.add(t={c:L,f:n})}),abort(){q.tasks.delete(t)}}}function o5(L,t){z5(()=>{L.dispatchEvent(new CustomEvent(t))})}function C3(L){if(L==="float")return"cssFloat";if(L==="offset")return"cssOffset";if(L.startsWith("--"))return L;const t=L.split("-");return t.length===1?t[0]:t[0]+t.slice(1).map(n=>n[0].toUpperCase()+n.slice(1)).join("")}function I5(L){const t={},n=L.split(";");for(const s of n){const[e,i]=s.split(":");if(!e||i===void 0)break;const l=C3(e.trim());t[l]=i.trim()}return t}const R3=L=>L;function N5(L,t,n,s){var e=(L&v3)!==0,i=(L&c3)!==0,l=e&&i,a=(L&k3)!==0,F=l?"both":e?"in":"out",w,c=t.inert,f=t.style.overflow,d,Q;function k(){return z5(()=>w??=n()(t,s?.()??{},{direction:F}))}var h={is_global:a,in(){if(t.inert=c,!e){Q?.abort(),Q?.reset?.();return}i||d?.abort(),d=v5(t,k(),Q,1,()=>{o5(t,"introend"),d?.abort(),d=w=void 0,t.style.overflow=f})},out(M){if(!i){M?.(),w=void 0;return}t.inert=!0,Q=v5(t,k(),d,0,()=>{o5(t,"outroend"),M?.()})},stop:()=>{d?.abort(),Q?.abort()}},g=H5;if((g.nodes.t??=[]).push(h),e&&F3){var y=a;if(!y){for(var p=g.parent;p&&(p.f&d3)!==0;)for(;(p=p.parent)&&(p.f&p3)===0;);y=!p||(p.f&x3)!==0}y&&f3(()=>{G5(()=>h.in())})}}function v5(L,t,n,s,e){var i=s===1;if(M3(t)){var l,a=!1;return _3(()=>{if(!a){var g=t({direction:i?"in":"out"});l=v5(L,g,n,s,e)}}),{abort:()=>{a=!0,l?.abort()},deactivate:()=>l.deactivate(),reset:()=>l.reset(),t:()=>l.t()}}if(n?.deactivate(),!t?.duration&&!t?.delay)return o5(L,i?"introstart":"outrostart"),e(),{abort:$,deactivate:$,reset:$,t:()=>s};const{delay:F=0,css:w,tick:c,easing:f=R3}=t;var d=[];if(i&&n===void 0&&(c&&c(0,1),w)){var Q=I5(w(0,1));d.push(Q,Q)}var k=()=>1-s,h=L.animate(d,{duration:F,fill:"forwards"});return h.onfinish=()=>{h.cancel(),o5(L,i?"introstart":"outrostart");var g=n?.t()??1-s;n?.abort();var y=s-g,p=t.duration*Math.abs(y),M=[];if(p>0){var P=!1;if(w)for(var L5=Math.ceil(p/16.666666666666668),U=0;U<=L5;U+=1){var s5=g+y*f(U/L5),X=I5(w(s5,1-s5));M.push(X),P||=X.overflow==="hidden"}P&&(L.style.overflow="hidden"),k=()=>{var V=h.currentTime;return g+y*f(V/p)},c&&A3(()=>{if(h.playState!=="running")return!1;var V=k();return c(V,1-V),!0})}h=L.animate(M,{duration:p,fill:"forwards"}),h.onfinish=()=>{k=()=>s,c?.(s,1-s),e()}},{abort:()=>{h&&(h.cancel(),h.effect=null,h.onfinish=$)},deactivate:()=>{e=$},reset:()=>{s===0&&c?.(1,0)},t:()=>k()}}class e5{static DOWN=0;static RIGHT=1;static LEFT=2;static UP=3;static BUMPER_LEFT=4;static BUMPER_RIGHT=5;static TRIGGER_LEFT=6;static TRIGGER_RIGHT=7;static VIEW=8;static MENU=9;static AXIS_BUTTON_LEFT=10;static AXIS_BUTTON_RIGHT=11;static DPAD_UP=12;static DPAD_DOWN=13;static DPAD_LEFT=14;static DPAD_RIGHT=15;static HOME=16;static DPAD_HORIZONTAL="dpad_horizontal";static DPAD_VERTICAL="dpad_vertical";static LEFT_AXIS="left_axis";static LEFT_HORIZONTAL="left_horizontal";static LEFT_VERTICAL="left_vertical";static LEFT_UP="left_up";static LEFT_RIGHT="left_right";static LEFT_LEFT="left_left";static LEFT_DOWN="left_down";static RIGHT_AXIS="right_axis";static RIGHT_HORIZONTAL="right_horizontal";static RIGHT_VERTICAL="right_vertical";static RIGHT_UP="right_up";static RIGHT_RIGHT="right_right";static RIGHT_LEFT="right_left";static RIGHT_DOWN="right_down";static CROSS=0;static CIRCLE=1;static SQUARE=2;static TRIANGLE=3;static L1=4;static R1=5;static L2=6;static R2=7;static SHARE=8;static OPTIONS=9;static PS=16;static A=0;static B=1;static X=2;static Y=3;static LB=4;static RB=5;static TL=6;static TR=7;static BACK=8;static START=9;static XBOX=16}const I3=(L,t)=>Math.sqrt(L**2+t**2),N3=(L,t)=>Math.atan2(t,L),q3=(L,t)=>[L*Math.cos(t),L*Math.sin(t)],O3=(L,t)=>Math.min(Math.max(-t,L),t);function V5(L,t){return L.gamepad===-1||L.gamepad===t.index}function K5(L){const t=document.activeElement,n=Array.from(document.querySelectorAll('input, select, textarea, button, [tabindex]:not([tabindex="-1"])'));if(!t)return;let s=n.indexOf(t);for(let e=1;e<n.length;e++){let i=(s+e*L)%n.length;i<0&&(i=n.length-1,s=i);const l=n[i];if(!l.hasAttribute("disabled"))return l}}function H1(){const L=K5(-1);L&&L.focus()}function G1(){const L=K5(1);L&&L.focus()}class H3{focusElement;requiresFocus;input;disabled=!1;onpressedCallback;onholdCallback;onreleaseCallback;consumePress;constructor(t,n,s=!1,e,i,l,a=!1){this.onpressedCallback=e,this.onholdCallback=i,this.onreleaseCallback=l,this.focusElement=n,this.input=t,this.requiresFocus=s,this.consumePress=a}onpressed(){return this.disabled?!1:(this.onpressedCallback&&this.onpressedCallback(),this.consumePress)}onhold(){this.onholdCallback&&this.onholdCallback()}onrelease(){this.onreleaseCallback&&this.onreleaseCallback()}thisGamepadButton(t,n){return V5(this.input,t)}onbuttonpressed(t,n){return this.onpressed()}onbuttonrelease(t,n){this.onrelease()}onbuttonhold(t,n){this.onhold()}onupdate(t){}thisKey(t){return!1}onkeypressed(t){return this.thisKey(t)&&this.onpressed()}onkeyrelease(t){this.thisKey(t)&&this.onrelease()}onkeyhold(t){this.thisKey(t)&&this.onhold()}}const u=k5({components:{},activeComponents:[],showHints:!1,context:"default"}),q5=L=>{u.activeComponents.includes(L)||u.activeComponents.push(L)},G3=(L,t)=>{if(L.forEach(n=>{u.components[n]||(u.components[n]=[]),u.components[n].includes(t)||u.components[n].push(t)}),!t.requiresFocus&&L.includes("default")&&q5(t),t.focusElement&&t.requiresFocus){const n=()=>{L.includes(u.context)&&q5(t)},s=()=>{X5(t)};t.focusElement.addEventListener("focus",n),t.focusElement.addEventListener("blur",s),t._focusCleanup=()=>{t.focusElement?.removeEventListener("focus",n),t.focusElement?.removeEventListener("blur",s)}}},X5=L=>{u.activeComponents=u.activeComponents.filter(t=>t!==L)},z3=(L,t)=>{L.forEach(n=>{u.components[n]&&(u.components[n]=u.components[n].filter(s=>s!==t))}),X5(t),t._focusCleanup&&t._focusCleanup()};class D3 extends H3{gamepadActive=!0;pos=[0,0];updatePosition;xPos=!1;xNeg=!1;yPos=!1;yNeg=!1;constructor(t,n,s,e=!1){super(t,s,e),this.updatePosition=n}onrelease(){let t=this.pos[0],n=this.pos[1];(this.xPos||this.xNeg)&&(t=0),(this.yPos||this.yNeg)&&(n=0),!(t==this.pos[0]&&n==this.pos[1])&&(this.pos=[t,n],this.updatePosition(!0,this.pos))}onhold(){let t=this.pos[0],n=this.pos[1];this.xPos?t=1:this.xNeg&&(t=-1),this.yPos?n=1:this.yNeg&&(n=-1),!(t==this.pos[0]&&n==this.pos[1])&&(this.pos=[t,n],this.updatePosition(!0,this.pos))}updateKeys(t){const n=this.input,s=t.key.toLowerCase();this.xPos=n.key_x_pos.includes(s),this.xNeg=n.key_x_neg.includes(s),this.yPos=n.key_y_pos.includes(s),this.yNeg=n.key_y_neg.includes(s)}thisKey(t){return this.xPos||this.xNeg||this.yPos||this.yNeg}onkeyrelease(t){this.disabled||(this.updateKeys(t),super.onkeyrelease(t))}onkeyhold(t){this.disabled||(this.updateKeys(t),super.onkeyhold(t))}updateButton(t){const n=this.input;this.xPos=n.button_x_pos.includes(t),this.xNeg=n.button_x_neg.includes(t),this.yPos=n.button_y_pos.includes(t),this.yNeg=n.button_y_neg.includes(t)}onbuttonhold(t,n){this.disabled||(this.updateButton(n),super.onbuttonhold(t,n))}onbuttonrelease(t,n){this.disabled||(this.updateButton(n),super.onbuttonrelease(t,n))}onupdate(t){if(this.disabled||!this.gamepadActive||!V5(this.input,t))return;const n=this.input;let s=t.axes[n.axes_x],e=t.axes[n.axes_y];if(n.invert_x&&(s=-s),n.invert_y&&(e=-e),Math.abs(s)<n.deadzoneX&&Math.abs(e)<n.deadzoneY){this.updatePosition(!1,[0,0]);return}this.updatePosition(!0,[s,e])}activateGamepad=()=>{this.disabled||(this.gamepadActive=!0)}}class B3 extends D3{radius;calcPos;constructor(t,n,s,e,i,l=!1){super(t,e,i,l),this.radius=n,this.calcPos=s}onrelease(){let t=this.pos[0],n=this.pos[1];(this.xPos||this.xNeg)&&(t=0),(this.yPos||this.yNeg)&&(n=0),!(t==this.pos[0]&&n==this.pos[1])&&(this.calcPos(t*this.radius,n*this.radius),this.pos=[t,n],this.gamepadActive=!0)}onhold(){let t=this.pos[0],n=this.pos[1];this.xPos?t=1:this.xNeg&&(t=-1),this.yPos?n=1:this.yNeg&&(n=-1),!(t==this.pos[0]&&n==this.pos[1])&&(this.pos=[t,n],this.calcPos(t*this.radius,n*this.radius),this.gamepadActive=!1)}}const S3=L=>L;function O5(L,{delay:t=0,duration:n=400,easing:s=S3}={}){const e=+getComputedStyle(L).opacity;return{delay:t,duration:n,easing:s,css:i=>`opacity: ${i*e}`}}const U3=`<svg width="64" height="64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs/>
  <g>
    <path
         stroke="none"
...
`,W3=`<svg width="64" height="64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs/>
  <g>
...
</svg>`;var b1=S('<div class="svg-container svelte-8rvg2f"><!></div>');function T(L,t){D5(t,!0);let n=v(t,"width",3,40),s=v(t,"height",3,40),e=v(t,"color",3,"#666666");const i={0:p4,1:x4,2:f4,3:k4,4:v4,5:c4,6:M4,7:_4,8:m4,9:u4,10:y4,11:b4,12:E4,13:T4,14:P4,15:A4,16:C4,dpad_horizontal:R4,dpad_vertical:I4,left_axis:N4,left_horizontal:q4,left_vertical:O4,left_up:H4,left_right:G4,left_left:z4,left_down:D4,right_axis:B4,right_horizontal:S4,right_vertical:U4,right_up:V4,right_right:K4,right_left:X4,right_down:W4},l={0:j4,1:Y4,2:J4,3:Z4,4:$4,5:t1,6:n1,7:L1,8:s1,9:Q1,10:e1,11:i1,12:o1,13:l1,14:w1,15:g1,dpad_horizontal:r1,dpad_vertical:h1,left_axis:a1,left_horizontal:F1,left_vertical:d1,left_up:p1,left_right:x1,left_left:f1,left_down:k1,right_axis:v1,right_horizontal:c1,right_vertical:M1,right_up:_1,right_right:m1,right_left:u1,right_down:y1},a={any:W3,"/":j3,"*":Y3,",":J3,".":Z3,":":$3,";":t2,"[":n2,"]":L2,"+":s2,"-":Q2,"~":e2," ":i2,'"':o2,backspace:l2,capslock:w2,tab:g2,shift:r2,arrowleft:h2,arrowright:a2,arrowup:F2,arrowdown:d2,pagedown:p2,pageup:x2,end:f2,home:k2,control:v2,enter:c2,a:M2,b:_2,c:m2,d:u2,e:y2,f:b2,g:E2,h:T2,i:P2,j:A2,k:C2,l:R2,m:I2,n:N2,o:q2,p:O2,q:H2,r:G2,s:z2,t:D2,u:B2,v:S2,w:U2,x:V2,y:K2,z:X2,0:W2,1:j2,2:Y2,3:J2,4:Z2,5:$2,6:t4,7:n4,8:L4,9:s4,f1:Q4,f2:e4,f3:i4,f4:o4,f5:l4,f6:w4,f7:g4,f8:r4,f9:h4,f10:a4,f11:F4,f12:d4},F={0:U3,1:V3,2:K3,3:X3};let w=S5(void 0),c=t.type;switch(["ps4","ps5"].includes(t.type)&&(c="ps"),c){case"keyboard_mouse":let k=t.input.toLowerCase();N(w,a[k],!0);break;case"xbox":N(w,l[t.input],!0);break;case"ps":N(w,i[t.input],!0);break;case"generic":t.input in F?N(w,F[t.input],!0):N(w,i[t.input],!0)}var f=m3(),d=n5(f);{var Q=k=>{var h=b1();let g;var y=C(h);T3(y,()=>I(w).replace("<g>",`<g transform="scale(${Math.min(n()/64,s()/64)})">`).replace('fill="#FFFFFF"',`fill="${e()}"`)),R(h),i5(()=>g=K(h,"",g,{height:`${s()??""}px`,width:`${n()??""}px`})),G(k,h)};b(d,k=>{I(w)&&k(Q)})}G(L,f),B5()}l5(["pointerdown","click","pointerup","pointerout"]);l5(["keydown","click","pointerup","touchstart","touchend","pointerout","pointerdown"]);var E1=S('<div class="hint hint-up svelte-tppe42"><!> <!></div> <div class="hint hint-down svelte-tppe42"><!> <!></div>',1),T1=S("<!> <br/>",1),P1=S("<!> <br/>",1),A1=S('<div class="hint hint-left svelte-tppe42"><!> <!></div> <div class="hint hint-right svelte-tppe42"><!> <!></div>',1),C1=S('<div class="hints_container svelte-tppe42"><div class="hint svelte-tppe42"><!></div> <!> <!></div>'),R1=S('<div class="joystick_area svelte-tppe42" role="button"><!> <div class="joystick_container svelte-tppe42"><div class="joystick_back svelte-tppe42"></div> <div class="joystick_front svelte-tppe42"></div></div></div>');function z1(L,t){D5(t,!0);let n=v(t,"disabled",3,!1),s=v(t,"size",3,100),e=v(t,"backgroundWidth",3,200),i=v(t,"backgroundHeight",3,200),l=v(t,"color",3,"rgb(106, 191, 163)"),a=v(t,"defaultOpacity",3,.5),F=v(t,"activeOpacity",3,.8),w=v(t,"border",3,1),c=v(t,"borderColor",3,"black"),f=v(t,"position",31,()=>k5([0,0])),d=v(t,"style",3,"background-color: rgb(215, 219, 221);"),Q=v(t,"inputMapping",19,()=>({name:"Virtual Joystick",gamepad:-1,axes_x:0,axes_y:1,button_x_pos:[e5.DPAD_RIGHT],button_x_neg:[e5.DPAD_LEFT],button_y_pos:[e5.DPAD_DOWN],button_y_neg:[e5.DPAD_UP],deadzoneX:.05,deadzoneY:.05,key_x_pos:["d"],key_x_neg:["a"],key_y_pos:["s"],key_y_neg:["w"],invert_x:!1,invert_y:!1})),k=v(t,"context",19,()=>["default"]),h=v(t,"requiresFocus",3,!1);const g=s()/2;let y=!1,p,M,P=S5(k5(a()));function L5(){return p}function U(r){if(n()||!Q().gamepad||!y||!r.target)return;const x=r.target.getBoundingClientRect(),O=r.x-x.x,A=r.y-x.y;M&&(M.gamepadActive=!1,s5(O,A))}function s5(r,x){let O=r-e()/2,A=x-i()/2;X(O,A)}function X(r,x){Q().disable_axes&&(Q().disable_axes.includes("x")&&(r=0),Q().disable_axes.includes("y")&&(x=0));const O=I3(r,x),A=N3(r,x);let g5=O3(O,g),Q5=q3(g5,A),z=Q5[0]/g,D=Q5[1]/g;if(Math.abs(z)<Q().deadzoneX&&Math.abs(D)<Q().deadzoneY){f([0,0]),N(P,a());return}z=Math.abs(z)<1e-6?0:z,D=Math.abs(D)<1e-6?0:D,N(P,F()),f([z,D])}function V(){y=!1,N(P,a()),f([0,0])}function W5(r,x){N(P,r?F():a(),!0),Q().disable_axes&&(Q().disable_axes.includes("x")&&(x[0]=0),Q().disable_axes.includes("y")&&(x[1]=0)),f(x)}u3(()=>(G5(()=>{M=new B3(Q(),g,X,W5,p,h()),G3(k(),M)}),()=>{M&&z3(k(),M)}));var j5={getElement:L5},_=R1();C5("pointerup",y3,V),E3(_,"tabindex",0);let c5;var M5=C(_);{var Y5=r=>{var x=C1();let O;var A=C(x),g5=C(A);{var Q5=m=>{T(m,{type:"generic",input:"left_axis"})},z=t5(()=>[0,1].includes(Q().axes_x)&&[0,1].includes(Q().axes_y)),D=m=>{T(m,{type:"generic",input:"right_axis"})},$5=t5(()=>[2,3].includes(Q().axes_x)&&[2,3].includes(Q().axes_y));b(g5,m=>{I(z)?m(Q5):I($5)&&m(D,1)})}R(A);var b5=E(A,2);{var t3=m=>{var W=E1(),B=n5(W),j=C(B);{var r5=o=>{T(o,{type:"keyboard_mouse",get input(){return Q().key_y_neg[0]}})};b(j,o=>{Q().key_y_neg.length>0&&o(r5)})}var h5=E(j,2);{var a5=o=>{T(o,{type:"generic",get input(){return Q().button_y_neg[0]}})};b(h5,o=>{Q().button_y_neg.length>0&&o(a5)})}R(B);var Y=E(B,2),J=C(Y);{var F5=o=>{T(o,{type:"keyboard_mouse",get input(){return Q().key_y_pos[0]}})};b(J,o=>{Q().key_y_pos.length>0&&o(F5)})}var d5=E(J,2);{var p5=o=>{T(o,{type:"generic",get input(){return Q().button_y_pos[0]}})};b(d5,o=>{Q().button_y_pos.length>0&&o(p5)})}R(Y),G(m,W)},n3=t5(()=>!Q().disable_axes?.includes("y"));b(b5,m=>{I(n3)&&m(t3)})}var L3=E(b5,2);{var s3=m=>{var W=A1(),B=n5(W),j=C(B);{var r5=o=>{var Z=T1(),x5=n5(Z);T(x5,{type:"keyboard_mouse",get input(){return Q().key_x_neg[0]}}),R5(2),G(o,Z)};b(j,o=>{Q().key_x_neg.length>0&&o(r5)})}var h5=E(j,2);{var a5=o=>{T(o,{type:"generic",get input(){return Q().button_x_neg[0]}})};b(h5,o=>{Q().button_x_neg.length>0&&o(a5)})}R(B);var Y=E(B,2),J=C(Y);{var F5=o=>{var Z=P1(),x5=n5(Z);T(x5,{type:"keyboard_mouse",get input(){return Q().key_x_pos[0]}}),R5(2),G(o,Z)};b(J,o=>{Q().key_x_pos.length>0&&o(F5)})}var d5=E(J,2);{var p5=o=>{T(o,{type:"generic",get input(){return Q().button_x_pos[0]}})};b(d5,o=>{Q().button_x_pos.length>0&&o(p5)})}R(Y),G(m,W)},Q3=t5(()=>!Q().disable_axes?.includes("x"));b(L3,m=>{I(Q3)&&m(s3)})}R(x),i5(()=>O=K(x,"",O,{width:e()+"px",height:i()+"px"})),N5(2,x,()=>O5),N5(1,x,()=>O5),G(r,x)},J5=t5(()=>u.showHints&&k().includes(u.context));b(M5,r=>{I(J5)&&r(Y5)})}var w5=E(M5,2);let _5;var m5=C(w5);let u5;var Z5=E(m5,2);let y5;return R(w5),R(_),b3(_,r=>p=r,()=>p),i5(()=>{c5=K(_,d(),c5,{width:e()+"px",height:i()+"px"}),_5=K(w5,"",_5,{left:(e()-s())/2+"px",top:(i()-s())/2+"px"}),u5=K(m5,"",u5,{width:s()+"px",height:s()+"px",background:l(),opacity:I(P),transition:"none",border:w()>0?w()+"px solid "+c():0}),y5=K(Z5,"",y5,{left:f()[0]*g+"px",top:f()[1]*g+"px","margin-top":g/2+"px","margin-left":g/2+"px",transition:"opacity 0.2s ease-in-out",width:g+"px",height:g+"px",background:l(),opacity:I(P),border:w()>0?w()+"px solid "+c():0})}),H("keydown",_,()=>{p.focus()}),H("click",_,()=>{p.focus()}),H("pointerdown",_,r=>{n()||(r.stopImmediatePropagation(),y=!0,U(r))}),H("pointerup",_,()=>{M?.activateGamepad()}),C5("pointerleave",_,()=>{M?.activateGamepad()}),H("pointermove",_,U),H("touchstart",_,()=>{}),H("touchend",_,()=>{M?.activateGamepad()}),H("pointerout",_,()=>{M?.activateGamepad()}),G(L,_),B5(j5)}l5(["keydown","click","pointerdown","pointerup","pointermove","touchstart","touchend","pointerout"]);l5(["pointerdown"]);export{e5 as G,T as I,z1 as J,H3 as a,V5 as b,u as c,q5 as d,q as e,O5 as f,G1 as g,H1 as h,A3 as l,G3 as r,N5 as t,z3 as u};

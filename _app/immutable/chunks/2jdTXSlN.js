import{q as E5,r as Q3,c as s3,a as G,f as B,d as l5,g as T5,b as H}from"./CuBzguH3.js";import{t as i5,h as P5,L as A5,am as H5,bj as e3,Q as C5,R as i3,ab as o3,bh as l3,be as w3,d as g3,b6 as h3,bk as r3,bl as a3,i as k5,ag as F3,bm as d3,bc as p3,e as x3,j as k3,bn as f3,bo as v3,bp as c3,as as M3,x as _3,az as $,aP as G5,ae as f5,p as z5,I as N,f as n5,a as D5,J as S5,g as I,c as C,r as R,H as m3,bi as u3,s as E,G as t5,n as R5}from"./CkSIZBiO.js";import{p as v,i as b,b as y3}from"./BphYHr6V.js";import{b as X,d as b3}from"./BwRQ8euw.js";function E3(L,t,n=!1,Q=!1,e=!1){var i=L,l="";i5(()=>{var a=H5;if(l===(l=t()??"")){P5&&A5();return}if(a.nodes!==null&&(e3(a.nodes.start,a.nodes.end),a.nodes=null),l!==""){if(P5){C5.data;for(var F=A5(),w=F;F!==null&&(F.nodeType!==i3||F.data!=="");)w=F,F=o3(F);if(F===null)throw l3(),w3;E5(C5,w),i=g3(F);return}var c=n?r3:Q?a3:void 0,k=h3(n?"svg":Q?"math":"template",c);k.innerHTML=l;var d=n||Q?k:k.content;if(E5(k5(d),d.lastChild),n||Q)for(;k5(d);)i.before(k5(d));else i.before(d)}})}const T3=()=>performance.now(),O={tick:L=>requestAnimationFrame(L),now:()=>T3(),tasks:new Set};function B5(){const L=O.now();O.tasks.forEach(t=>{t.c(L)||(O.tasks.delete(t),t.f())}),O.tasks.size!==0&&O.tick(B5)}function P3(L){let t;return O.tasks.size===0&&O.tick(B5),{promise:new Promise(n=>{O.tasks.add(t={c:L,f:n})}),abort(){O.tasks.delete(t)}}}function o5(L,t){G5(()=>{L.dispatchEvent(new CustomEvent(t))})}function A3(L){if(L==="float")return"cssFloat";if(L==="offset")return"cssOffset";if(L.startsWith("--"))return L;const t=L.split("-");return t.length===1?t[0]:t[0]+t.slice(1).map(n=>n[0].toUpperCase()+n.slice(1)).join("")}function I5(L){const t={},n=L.split(";");for(const Q of n){const[e,i]=Q.split(":");if(!e||i===void 0)break;const l=A3(e.trim());t[l]=i.trim()}return t}const C3=L=>L;function N5(L,t,n,Q){var e=(L&v3)!==0,i=(L&c3)!==0,l=e&&i,a=(L&f3)!==0,F=l?"both":e?"in":"out",w,c=t.inert,k=t.style.overflow,d,s;function f(){return G5(()=>w??=n()(t,Q?.()??{},{direction:F}))}var r={is_global:a,in(){if(t.inert=c,!e){s?.abort(),s?.reset?.();return}i||d?.abort(),d=v5(t,f(),s,1,()=>{o5(t,"introend"),d?.abort(),d=w=void 0,t.style.overflow=k})},out(M){if(!i){M?.(),w=void 0;return}t.inert=!0,s=v5(t,f(),d,0,()=>{o5(t,"outroend"),M?.()})},stop:()=>{d?.abort(),s?.abort()}},g=H5;if((g.nodes.t??=[]).push(r),e&&Q3){var y=a;if(!y){for(var p=g.parent;p&&(p.f&F3)!==0;)for(;(p=p.parent)&&(p.f&d3)===0;);y=!p||(p.f&p3)!==0}y&&x3(()=>{k3(()=>r.in())})}}function v5(L,t,n,Q,e){var i=Q===1;if(M3(t)){var l,a=!1;return _3(()=>{if(!a){var g=t({direction:i?"in":"out"});l=v5(L,g,n,Q,e)}}),{abort:()=>{a=!0,l?.abort()},deactivate:()=>l.deactivate(),reset:()=>l.reset(),t:()=>l.t()}}if(n?.deactivate(),!t?.duration&&!t?.delay)return o5(L,i?"introstart":"outrostart"),e(),{abort:$,deactivate:$,reset:$,t:()=>Q};const{delay:F=0,css:w,tick:c,easing:k=C3}=t;var d=[];if(i&&n===void 0&&(c&&c(0,1),w)){var s=I5(w(0,1));d.push(s,s)}var f=()=>1-Q,r=L.animate(d,{duration:F,fill:"forwards"});return r.onfinish=()=>{r.cancel(),o5(L,i?"introstart":"outrostart");var g=n?.t()??1-Q;n?.abort();var y=Q-g,p=t.duration*Math.abs(y),M=[];if(p>0){var P=!1;if(w)for(var L5=Math.ceil(p/16.666666666666668),U=0;U<=L5;U+=1){var Q5=g+y*k(U/L5),K=I5(w(Q5,1-Q5));M.push(K),P||=K.overflow==="hidden"}P&&(L.style.overflow="hidden"),f=()=>{var V=r.currentTime;return g+y*k(V/p)},c&&P3(()=>{if(r.playState!=="running")return!1;var V=f();return c(V,1-V),!0})}r=L.animate(M,{duration:p,fill:"forwards"}),r.onfinish=()=>{f=()=>Q,c?.(Q,1-Q),e()}},{abort:()=>{r&&(r.cancel(),r.effect=null,r.onfinish=$)},deactivate:()=>{e=$},reset:()=>{Q===0&&c?.(1,0)},t:()=>f()}}class e5{static DOWN=0;static RIGHT=1;static LEFT=2;static UP=3;static BUMPER_LEFT=4;static BUMPER_RIGHT=5;static TRIGGER_LEFT=6;static TRIGGER_RIGHT=7;static VIEW=8;static MENU=9;static AXIS_BUTTON_LEFT=10;static AXIS_BUTTON_RIGHT=11;static DPAD_UP=12;static DPAD_DOWN=13;static DPAD_LEFT=14;static DPAD_RIGHT=15;static HOME=16;static DPAD_HORIZONTAL="dpad_horizontal";static DPAD_VERTICAL="dpad_vertical";static LEFT_AXIS="left_axis";static LEFT_HORIZONTAL="left_horizontal";static LEFT_VERTICAL="left_vertical";static LEFT_UP="left_up";static LEFT_RIGHT="left_right";static LEFT_LEFT="left_left";static LEFT_DOWN="left_down";static RIGHT_AXIS="right_axis";static RIGHT_HORIZONTAL="right_horizontal";static RIGHT_VERTICAL="right_vertical";static RIGHT_UP="right_up";static RIGHT_RIGHT="right_right";static RIGHT_LEFT="right_left";static RIGHT_DOWN="right_down";static CROSS=0;static CIRCLE=1;static SQUARE=2;static TRIANGLE=3;static L1=4;static R1=5;static L2=6;static R2=7;static SHARE=8;static OPTIONS=9;static PS=16;static A=0;static B=1;static X=2;static Y=3;static LB=4;static RB=5;static TL=6;static TR=7;static BACK=8;static START=9;static XBOX=16}const R3=(L,t)=>Math.sqrt(L**2+t**2),I3=(L,t)=>Math.atan2(t,L),N3=(L,t)=>[L*Math.cos(t),L*Math.sin(t)],O3=(L,t)=>Math.min(Math.max(-t,L),t);function U5(L,t){return L.gamepad===-1||L.gamepad===t.index}function V5(L){const t=document.activeElement,n=Array.from(document.querySelectorAll('input, select, textarea, button, [tabindex]:not([tabindex="-1"])'));if(!t)return;let Q=n.indexOf(t);for(let e=1;e<n.length;e++){let i=(Q+e*L)%n.length;i<0&&(i=n.length-1,Q=i);const l=n[i];if(!l.hasAttribute("disabled"))return l}}function q1(){const L=V5(-1);L&&L.focus()}function H1(){const L=V5(1);L&&L.focus()}class q3{focusElement;requiresFocus;input;disabled=!1;onpressedCallback;onholdCallback;onreleaseCallback;consumePress;constructor(t,n,Q=!1,e,i,l,a=!1){this.onpressedCallback=e,this.onholdCallback=i,this.onreleaseCallback=l,this.focusElement=n,this.input=t,this.requiresFocus=Q,this.consumePress=a}onpressed(){return this.disabled?!1:(this.onpressedCallback&&this.onpressedCallback(),this.consumePress)}onhold(){this.onholdCallback&&this.onholdCallback()}onrelease(){this.onreleaseCallback&&this.onreleaseCallback()}thisGamepadButton(t,n){return U5(this.input,t)}onbuttonpressed(t,n){return this.onpressed()}onbuttonrelease(t,n){this.onrelease()}onbuttonhold(t,n){this.onhold()}onupdate(t){}thisKey(t){return!1}onkeypressed(t){return this.thisKey(t)&&this.onpressed()}onkeyrelease(t){this.thisKey(t)&&this.onrelease()}onkeyhold(t){this.thisKey(t)&&this.onhold()}}const _=f5({components:{},activeComponents:[],showHints:!1,context:"default"}),O5=L=>{_.activeComponents.includes(L)||_.activeComponents.push(L)},H3=(L,t)=>{L.forEach(n=>{_.components[n]||(_.components[n]=[]),_.components[n].push(t)}),!t.requiresFocus&&L.includes("default")&&O5(t),t.focusElement&&t.requiresFocus&&(t.focusElement.addEventListener("focus",()=>{L.includes(_.context)&&O5(t)}),t.focusElement.addEventListener("blur",()=>{_.activeComponents.splice(_.activeComponents.indexOf(t),1)}))},G3=(L,t)=>{L.forEach(n=>{_.components[n]&&_.components[n].splice(_.components[n].indexOf(t),1)}),_.activeComponents.includes(t)&&_.activeComponents.slice(_.activeComponents.indexOf(t))};class z3 extends q3{gamepadActive=!0;pos=[0,0];updatePosition;xPos=!1;xNeg=!1;yPos=!1;yNeg=!1;constructor(t,n,Q,e=!1){super(t,Q,e),this.updatePosition=n}onrelease(){let t=this.pos[0],n=this.pos[1];(this.xPos||this.xNeg)&&(t=0),(this.yPos||this.yNeg)&&(n=0),!(t==this.pos[0]&&n==this.pos[1])&&(this.pos=[t,n],this.updatePosition(!0,this.pos))}onhold(){let t=this.pos[0],n=this.pos[1];this.xPos?t=1:this.xNeg&&(t=-1),this.yPos?n=1:this.yNeg&&(n=-1),!(t==this.pos[0]&&n==this.pos[1])&&(this.pos=[t,n],this.updatePosition(!0,this.pos))}updateKeys(t){const n=this.input,Q=t.key.toLowerCase();this.xPos=n.key_x_pos.includes(Q),this.xNeg=n.key_x_neg.includes(Q),this.yPos=n.key_y_pos.includes(Q),this.yNeg=n.key_y_neg.includes(Q)}thisKey(t){return this.xPos||this.xNeg||this.yPos||this.yNeg}onkeyrelease(t){this.disabled||(this.updateKeys(t),super.onkeyrelease(t))}onkeyhold(t){this.disabled||(this.updateKeys(t),super.onkeyhold(t))}updateButton(t){const n=this.input;this.xPos=n.button_x_pos.includes(t),this.xNeg=n.button_x_neg.includes(t),this.yPos=n.button_y_pos.includes(t),this.yNeg=n.button_y_neg.includes(t)}onbuttonhold(t,n){this.disabled||(this.updateButton(n),super.onbuttonhold(t,n))}onbuttonrelease(t,n){this.disabled||(this.updateButton(n),super.onbuttonrelease(t,n))}onupdate(t){if(this.disabled||!this.gamepadActive||!U5(this.input,t))return;const n=this.input;let Q=t.axes[n.axes_x],e=t.axes[n.axes_y];if(n.invert_x&&(Q=-Q),n.invert_y&&(e=-e),Math.abs(Q)<n.deadzoneX&&Math.abs(e)<n.deadzoneY){this.updatePosition(!1,[0,0]);return}this.updatePosition(!0,[Q,e])}activateGamepad=()=>{this.disabled||(this.gamepadActive=!0)}}class D3 extends z3{radius;calcPos;constructor(t,n,Q,e,i,l=!1){super(t,e,i,l),this.radius=n,this.calcPos=Q}onrelease(){let t=this.pos[0],n=this.pos[1];(this.xPos||this.xNeg)&&(t=0),(this.yPos||this.yNeg)&&(n=0),!(t==this.pos[0]&&n==this.pos[1])&&(this.calcPos(t*this.radius,n*this.radius),this.pos=[t,n],this.gamepadActive=!0)}onhold(){let t=this.pos[0],n=this.pos[1];this.xPos?t=1:this.xNeg&&(t=-1),this.yPos?n=1:this.yNeg&&(n=-1),!(t==this.pos[0]&&n==this.pos[1])&&(this.pos=[t,n],this.calcPos(t*this.radius,n*this.radius),this.gamepadActive=!1)}}const S3=L=>L;function q5(L,{delay:t=0,duration:n=400,easing:Q=S3}={}){const e=+getComputedStyle(L).opacity;return{delay:t,duration:n,easing:Q,css:i=>`opacity: ${i*e}`}}const B3=`<svg width="64" height="64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs/>
  <g>
    <path
         stroke="none"
...
`,U3=`<svg width="64" height="64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs/>
  <g>
  <path
     stroke="none"
...
`,V3=`<svg width="64" height="64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs/>
  <g>
    <path
     stroke="none"
...
`,X3=`<svg width="64" height="64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs/>
  <g>
    <path
     stroke="none"
...
`,K3=`<svg width="64" height="64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs/>
  <g>
...
</svg>`;var y1=B('<div class="svg-container svelte-8rvg2f"><!></div>');function T(L,t){z5(t,!0);let n=v(t,"width",3,40),Q=v(t,"height",3,40),e=v(t,"color",3,"#666666");const i={0:d4,1:p4,2:x4,3:k4,4:f4,5:v4,6:c4,7:M4,8:_4,9:m4,10:u4,11:y4,12:b4,13:E4,14:T4,15:P4,16:A4,dpad_horizontal:C4,dpad_vertical:R4,left_axis:I4,left_horizontal:N4,left_vertical:O4,left_up:q4,left_right:H4,left_left:G4,left_down:z4,right_axis:D4,right_horizontal:S4,right_vertical:B4,right_up:U4,right_right:V4,right_left:X4,right_down:K4},l={0:j4,1:W4,2:Y4,3:J4,4:Z4,5:$4,6:t1,7:n1,8:L1,9:Q1,10:s1,11:e1,12:i1,13:o1,14:l1,15:w1,dpad_horizontal:g1,dpad_vertical:h1,left_axis:r1,left_horizontal:a1,left_vertical:F1,left_up:d1,left_right:p1,left_left:x1,left_down:k1,right_axis:f1,right_horizontal:v1,right_vertical:c1,right_up:M1,right_right:_1,right_left:m1,right_down:u1},a={any:K3,"/":j3,"*":W3,",":Y3,".":J3,":":Z3,";":$3,"[":t2,"]":n2,"+":L2,"-":Q2,"~":s2," ":e2,'"':i2,backspace:o2,capslock:l2,tab:w2,shift:g2,arrowleft:h2,arrowright:r2,arrowup:a2,arrowdown:F2,pagedown:d2,pageup:p2,end:x2,home:k2,control:f2,enter:v2,a:c2,b:M2,c:_2,d:m2,e:u2,f:y2,g:b2,h:E2,i:T2,j:P2,k:A2,l:C2,m:R2,n:I2,o:N2,p:O2,q:q2,r:H2,s:G2,t:z2,u:D2,v:S2,w:B2,x:U2,y:V2,z:X2,0:K2,1:j2,2:W2,3:Y2,4:J2,5:Z2,6:$2,7:t4,8:n4,9:L4,f1:Q4,f2:s4,f3:e4,f4:i4,f5:o4,f6:l4,f7:w4,f8:g4,f9:h4,f10:r4,f11:a4,f12:F4},F={0:B3,1:U3,2:V3,3:X3};let w=S5(void 0),c=t.type;switch(["ps4","ps5"].includes(t.type)&&(c="ps"),c){case"keyboard_mouse":let f=t.input.toLowerCase();N(w,a[f],!0);break;case"xbox":N(w,l[t.input],!0);break;case"ps":N(w,i[t.input],!0);break;case"generic":t.input in F?N(w,F[t.input],!0):N(w,i[t.input],!0)}var k=s3(),d=n5(k);{var s=f=>{var r=y1();let g;var y=C(r);E3(y,()=>I(w).replace("<g>",`<g transform="scale(${Math.min(n()/64,Q()/64)})">`).replace('fill="#FFFFFF"',`fill="${e()}"`)),R(r),i5(()=>g=X(r,"",g,{height:`${Q()??""}px`,width:`${n()??""}px`})),G(f,r)};b(d,f=>{I(w)&&f(s)})}G(L,k),D5()}l5(["pointerdown","click","pointerup","pointerout"]);l5(["keydown","click","pointerup","touchstart","touchend","pointerout","pointerdown"]);var b1=B('<div class="hint hint-up svelte-tppe42"><!> <!></div> <div class="hint hint-down svelte-tppe42"><!> <!></div>',1),E1=B("<!> <br/>",1),T1=B("<!> <br/>",1),P1=B('<div class="hint hint-left svelte-tppe42"><!> <!></div> <div class="hint hint-right svelte-tppe42"><!> <!></div>',1),A1=B('<div class="hints_container svelte-tppe42"><div class="hint svelte-tppe42"><!></div> <!> <!></div>'),C1=B('<div class="joystick_area svelte-tppe42" role="button"><!> <div class="joystick_container svelte-tppe42"><div class="joystick_back svelte-tppe42"></div> <div class="joystick_front svelte-tppe42"></div></div></div>');function G1(L,t){z5(t,!0);let n=v(t,"disabled",3,!1),Q=v(t,"size",3,100),e=v(t,"backgroundWidth",3,200),i=v(t,"backgroundHeight",3,200),l=v(t,"color",3,"rgb(106, 191, 163)"),a=v(t,"defaultOpacity",3,.5),F=v(t,"activeOpacity",3,.8),w=v(t,"border",3,1),c=v(t,"borderColor",3,"black"),k=v(t,"position",31,()=>f5([0,0])),d=v(t,"style",3,"background-color: rgb(215, 219, 221);"),s=v(t,"inputMapping",19,()=>({name:"Virtual Joystick",gamepad:-1,axes_x:0,axes_y:1,button_x_pos:[e5.DPAD_RIGHT],button_x_neg:[e5.DPAD_LEFT],button_y_pos:[e5.DPAD_DOWN],button_y_neg:[e5.DPAD_UP],deadzoneX:.05,deadzoneY:.05,key_x_pos:["d"],key_x_neg:["a"],key_y_pos:["s"],key_y_neg:["w"],invert_x:!1,invert_y:!1})),f=v(t,"context",19,()=>["default"]),r=v(t,"requiresFocus",3,!1);const g=Q()/2;let y=!1,p,M,P=S5(f5(a()));function L5(){return p}function U(h){if(n()||!s().gamepad||!y||!h.target)return;const x=h.target.getBoundingClientRect(),q=h.x-x.x,A=h.y-x.y;M&&(M.gamepadActive=!1,Q5(q,A))}function Q5(h,x){let q=h-e()/2,A=x-i()/2;K(q,A)}function K(h,x){s().disable_axes&&(s().disable_axes.includes("x")&&(h=0),s().disable_axes.includes("y")&&(x=0));const q=R3(h,x),A=I3(h,x);let g5=O3(q,g),s5=N3(g5,A),z=s5[0]/g,D=s5[1]/g;if(Math.abs(z)<s().deadzoneX&&Math.abs(D)<s().deadzoneY){k([0,0]),N(P,a());return}z=Math.abs(z)<1e-6?0:z,D=Math.abs(D)<1e-6?0:D,N(P,F()),k([z,D])}function V(){y=!1,N(P,a()),k([0,0])}function X5(h,x){N(P,h?F():a(),!0),s().disable_axes&&(s().disable_axes.includes("x")&&(x[0]=0),s().disable_axes.includes("y")&&(x[1]=0)),k(x)}m3(()=>(M=new D3(s(),g,K,X5,p,r()),H3(f(),M),()=>{M&&G3(f(),M)}));var K5={getElement:L5},m=C1();T5("pointerup",u3,V),b3(m,"tabindex",0);let c5;var M5=C(m);{var j5=h=>{var x=A1();let q;var A=C(x),g5=C(A);{var s5=u=>{T(u,{type:"generic",input:"left_axis"})},z=t5(()=>[0,1].includes(s().axes_x)&&[0,1].includes(s().axes_y)),D=u=>{T(u,{type:"generic",input:"right_axis"})},J5=t5(()=>[2,3].includes(s().axes_x)&&[2,3].includes(s().axes_y));b(g5,u=>{I(z)?u(s5):I(J5)&&u(D,1)})}R(A);var b5=E(A,2);{var Z5=u=>{var j=b1(),S=n5(j),W=C(S);{var h5=o=>{T(o,{type:"keyboard_mouse",get input(){return s().key_y_neg[0]}})};b(W,o=>{s().key_y_neg.length>0&&o(h5)})}var r5=E(W,2);{var a5=o=>{T(o,{type:"generic",get input(){return s().button_y_neg[0]}})};b(r5,o=>{s().button_y_neg.length>0&&o(a5)})}R(S);var Y=E(S,2),J=C(Y);{var F5=o=>{T(o,{type:"keyboard_mouse",get input(){return s().key_y_pos[0]}})};b(J,o=>{s().key_y_pos.length>0&&o(F5)})}var d5=E(J,2);{var p5=o=>{T(o,{type:"generic",get input(){return s().button_y_pos[0]}})};b(d5,o=>{s().button_y_pos.length>0&&o(p5)})}R(Y),G(u,j)},$5=t5(()=>!s().disable_axes?.includes("y"));b(b5,u=>{I($5)&&u(Z5)})}var t3=E(b5,2);{var n3=u=>{var j=P1(),S=n5(j),W=C(S);{var h5=o=>{var Z=E1(),x5=n5(Z);T(x5,{type:"keyboard_mouse",get input(){return s().key_x_neg[0]}}),R5(2),G(o,Z)};b(W,o=>{s().key_x_neg.length>0&&o(h5)})}var r5=E(W,2);{var a5=o=>{T(o,{type:"generic",get input(){return s().button_x_neg[0]}})};b(r5,o=>{s().button_x_neg.length>0&&o(a5)})}R(S);var Y=E(S,2),J=C(Y);{var F5=o=>{var Z=T1(),x5=n5(Z);T(x5,{type:"keyboard_mouse",get input(){return s().key_x_pos[0]}}),R5(2),G(o,Z)};b(J,o=>{s().key_x_pos.length>0&&o(F5)})}var d5=E(J,2);{var p5=o=>{T(o,{type:"generic",get input(){return s().button_x_pos[0]}})};b(d5,o=>{s().button_x_pos.length>0&&o(p5)})}R(Y),G(u,j)},L3=t5(()=>!s().disable_axes?.includes("x"));b(t3,u=>{I(L3)&&u(n3)})}R(x),i5(()=>q=X(x,"",q,{width:e()+"px",height:i()+"px"})),N5(2,x,()=>q5),N5(1,x,()=>q5),G(h,x)},W5=t5(()=>_.showHints&&f().includes(_.context));b(M5,h=>{I(W5)&&h(j5)})}var w5=E(M5,2);let _5;var m5=C(w5);let u5;var Y5=E(m5,2);let y5;return R(w5),R(m),y3(m,h=>p=h,()=>p),i5(()=>{c5=X(m,d(),c5,{width:e()+"px",height:i()+"px"}),_5=X(w5,"",_5,{left:(e()-Q())/2+"px",top:(i()-Q())/2+"px"}),u5=X(m5,"",u5,{width:Q()+"px",height:Q()+"px",background:l(),opacity:I(P),transition:"none",border:w()>0?w()+"px solid "+c():0}),y5=X(Y5,"",y5,{left:k()[0]*g+"px",top:k()[1]*g+"px","margin-top":g/2+"px","margin-left":g/2+"px",transition:"opacity 0.2s ease-in-out",width:g+"px",height:g+"px",background:l(),opacity:I(P),border:w()>0?w()+"px solid "+c():0})}),H("keydown",m,()=>{p.focus()}),H("click",m,()=>{p.focus()}),H("pointerdown",m,h=>{n()||(h.stopImmediatePropagation(),y=!0,U(h))}),H("pointerup",m,()=>{M?.activateGamepad()}),T5("pointerleave",m,()=>{M?.activateGamepad()}),H("pointermove",m,U),H("touchstart",m,()=>{}),H("touchend",m,()=>{M?.activateGamepad()}),H("pointerout",m,()=>{M?.activateGamepad()}),G(L,m),D5(K5)}l5(["keydown","click","pointerdown","pointerup","pointermove","touchstart","touchend","pointerout"]);l5(["pointerdown"]);export{e5 as G,T as I,G1 as J,q3 as a,U5 as b,_ as c,O5 as d,O as e,q5 as f,H1 as g,q1 as h,P3 as l,H3 as r,N5 as t,G3 as u};

...
</svg>`;var x1=U('<div class="svg-container svelte-8rvg2f"><!></div>');function T(L,t){G5(t,!0);let n=v(t,"width",3,40),Q=v(t,"height",3,40),e=v(t,"color",3,"#666666");const i={0:i4,1:o4,2:l4,3:w4,4:g4,5:h4,6:r4,7:a4,8:F4,9:d4,10:p4,11:x4,12:f4,13:k4,14:v4,15:c4,16:M4,dpad_horizontal:_4,dpad_vertical:m4,left_axis:u4,left_horizontal:y4,left_vertical:b4,left_up:E4,left_right:T4,left_left:P4,left_down:C4,right_axis:A4,right_horizontal:R4,right_vertical:I4,right_up:N4,right_right:O4,right_left:q4,right_down:G4},l={0:H4,1:D4,2:z4,3:B4,4:S4,5:U4,6:V4,7:X4,8:K4,9:W4,10:j4,11:Y4,12:J4,13:Z4,14:$4,15:t1,dpad_horizontal:n1,dpad_vertical:L1,left_axis:Q1,left_horizontal:s1,left_vertical:e1,left_up:i1,left_right:o1,left_left:l1,left_down:w1,right_axis:g1,right_horizontal:h1,right_vertical:r1,right_up:a1,right_right:F1,right_left:d1,right_down:p1},d={any:G3,"/":H3,"*":D3,",":z3,".":B3,":":S3,";":U3,"[":V3,"]":X3,"+":K3,"-":W3,"~":j3," ":Y3,'"':J3,backspace:Z3,capslock:$3,tab:t2,shift:n2,arrowleft:L2,arrowright:Q2,arrowup:s2,arrowdown:e2,pagedown:i2,pageup:o2,end:l2,home:w2,control:g2,enter:h2,a:r2,b:a2,c:F2,d:d2,e:p2,f:x2,g:f2,h:k2,i:v2,j:c2,k:M2,l:_2,m:m2,n:u2,o:y2,p:b2,q:E2,r:T2,s:P2,t:C2,u:A2,v:R2,w:I2,x:N2,y:O2,z:q2,0:G2,1:H2,2:D2,3:z2,4:B2,5:S2,6:U2,7:V2,8:X2,9:K2,f1:W2,f2:j2,f3:Y2,f4:J2,f5:Z2,f6:$2,f7:t4,f8:n4,f9:L4,f10:Q4,f11:s4,f12:e4},p={0:I3,1:N3,2:O3,3:q3};let w=D5(void 0),a=t.type;switch(["ps4","ps5"].includes(t.type)&&(a="ps"),a){case"keyboard_mouse":let k=t.input.toLowerCase();O(w,d[k],!0);break;case"xbox":O(w,l[t.input],!0);break;case"ps":O(w,i[t.input],!0);break;case"generic":t.input in p?O(w,p[t.input],!0):O(w,i[t.input],!0)}var g=N5(),y=K(g);{var s=k=>{var F=x1();let h;var b=R(F);k3(b,()=>o5(w).replace("<g>",`<g transform="scale(${Math.min(n()/64,Q()/64)})">`).replace('fill="#FFFFFF"',`fill="${e()}"`)),I(F),i5(()=>h=W(F,"",h,{height:`${Q()??""}px`,width:`${n()??""}px`})),N(k,F)};u(y,k=>{o5(w)&&k(s)})}N(L,g),H5()}l5(["pointerdown","click","pointerup","pointerout"]);l5(["keydown","click","pointerup","touchstart","touchend","pointerout","pointerdown"]);var f1=U('<div class="hint hint-up svelte-tppe42"><!> <!></div> <div class="hint hint-down svelte-tppe42"><!> <!></div>',1),k1=U("<!> <br/>",1),v1=U("<!> <br/>",1),c1=U('<div class="hint hint-left svelte-tppe42"><!> <!></div> <div class="hint hint-right svelte-tppe42"><!> <!></div>',1),M1=U('<div class="hints_container svelte-tppe42"><div class="hint svelte-tppe42"><!></div> <!> <!></div>'),_1=U('<div class="joystick_area svelte-tppe42" role="button"><!> <div class="joystick_container svelte-tppe42"><div class="joystick_back svelte-tppe42"></div> <div class="joystick_front svelte-tppe42"></div></div></div>');function P1(L,t){G5(t,!0);let n=v(t,"disabled",3,!1),Q=v(t,"size",3,100),e=v(t,"backgroundWidth",3,200),i=v(t,"backgroundHeight",3,200),l=v(t,"color",3,"rgb(106, 191, 163)"),d=v(t,"defaultOpacity",3,.5),p=v(t,"activeOpacity",3,.8),w=v(t,"border",3,1),a=v(t,"borderColor",3,"black"),g=v(t,"position",31,()=>x5([0,0])),y=v(t,"style",3,"background-color: rgb(215, 219, 221);"),s=v(t,"inputMapping",19,()=>({name:"Virtual Joystick",gamepad:-1,axes_x:0,axes_y:1,button_x_pos:[e5.DPAD_RIGHT],button_x_neg:[e5.DPAD_LEFT],button_y_pos:[e5.DPAD_DOWN],button_y_neg:[e5.DPAD_UP],deadzoneX:.05,deadzoneY:.05,key_x_pos:["d"],key_x_neg:["a"],key_y_pos:["s"],key_y_neg:["w"],invert_x:!1,invert_y:!1})),k=v(t,"context",19,()=>["default"]),F=v(t,"requiresFocus",3,!1);const h=Q()/2;let b=!1,x,c,P=D5(x5(d()));function t5(){return x}function V(r){if(n()||!s().gamepad||!b||!r.target)return;const f=r.target.getBoundingClientRect(),G=r.x-f.x,C=r.y-f.y;c&&(c.gamepadActive=!1,n5(G,C))}function n5(r,f){let G=r-e()/2,C=f-i()/2;j(G,C)}function j(r,f){s().disable_axes&&(s().disable_axes.includes("x")&&(r=0),s().disable_axes.includes("y")&&(f=0));const G=m3(r,f),C=u3(r,f);let g5=b3(G,h),L5=y3(g5,C),z=L5[0]/h,H=L5[1]/h;if(Math.abs(z)<s().deadzoneX&&Math.abs(H)<s().deadzoneY){g([0,0]),O(P,d());return}z=Math.abs(z)<1e-6?0:z,H=Math.abs(H)<1e-6?0:H,O(P,p()),g([z,H])}function X(){b=!1,O(P,d()),g([0,0])}function U5(r,f){O(P,r?p():d(),!0),s().disable_axes&&(s().disable_axes.includes("x")&&(f[0]=0),s().disable_axes.includes("y")&&(f[1]=0)),g(f)}d3(()=>(c=new A3(s(),h,j,U5,x,F()),T3(k(),c),()=>{c&&P3(k(),c)}));var V5={getElement:t5},_=_1();y5("pointerup",p3,X),f3(_,"tabindex",0),_.__keydown=()=>{x.focus()},_.__click=()=>{x.focus()};let k5;_.__pointerdown=r=>{n()||(r.stopImmediatePropagation(),b=!0,V(r))},_.__pointerup=()=>{c?.activateGamepad()},_.__pointermove=V,_.__touchstart=()=>{},_.__touchend=()=>{c?.activateGamepad()},_.__pointerout=()=>{c?.activateGamepad()};var v5=R(_);{var X5=r=>{var f=M1();let G;var C=R(f),g5=R(C);{var L5=m=>{T(m,{type:"generic",input:"left_axis"})},z=m=>{var D=N5(),A=K(D);{var B=S=>{T(S,{type:"generic",input:"right_axis"})};u(A,S=>{[2,3].includes(s().axes_x)&&[2,3].includes(s().axes_y)&&S(B)},!0)}N(m,D)};u(g5,m=>{[0,1].includes(s().axes_x)&&[0,1].includes(s().axes_y)?m(L5):m(z,!1)})}I(C);var H=E(C,2);{var W5=m=>{var D=f1(),A=K(D),B=R(A);{var S=o=>{T(o,{type:"keyboard_mouse",get input(){return s().key_y_neg[0]}})};u(B,o=>{s().key_y_neg.length>0&&o(S)})}var h5=E(B,2);{var r5=o=>{T(o,{type:"generic",get input(){return s().button_y_neg[0]}})};u(h5,o=>{s().button_y_neg.length>0&&o(r5)})}I(A);var Y=E(A,2),J=R(Y);{var a5=o=>{T(o,{type:"keyboard_mouse",get input(){return s().key_y_pos[0]}})};u(J,o=>{s().key_y_pos.length>0&&o(a5)})}var F5=E(J,2);{var d5=o=>{T(o,{type:"generic",get input(){return s().button_y_pos[0]}})};u(F5,o=>{s().button_y_pos.length>0&&o(d5)})}I(Y),N(m,D)};u(H,m=>{s().disable_axes?.includes("y")||m(W5)})}var j5=E(H,2);{var Y5=m=>{var D=c1(),A=K(D),B=R(A);{var S=o=>{var Z=k1(),p5=K(Z);T(p5,{type:"keyboard_mouse",get input(){return s().key_x_neg[0]}}),P5(2),N(o,Z)};u(B,o=>{s().key_x_neg.length>0&&o(S)})}var h5=E(B,2);{var r5=o=>{T(o,{type:"generic",get input(){return s().button_x_neg[0]}})};u(h5,o=>{s().button_x_neg.length>0&&o(r5)})}I(A);var Y=E(A,2),J=R(Y);{var a5=o=>{var Z=v1(),p5=K(Z);T(p5,{type:"keyboard_mouse",get input(){return s().key_x_pos[0]}}),P5(2),N(o,Z)};u(J,o=>{s().key_x_pos.length>0&&o(a5)})}var F5=E(J,2);{var d5=o=>{T(o,{type:"generic",get input(){return s().button_x_pos[0]}})};u(F5,o=>{s().button_x_pos.length>0&&o(d5)})}I(Y),N(m,D)};u(j5,m=>{s().disable_axes?.includes("x")||m(Y5)})}I(f),i5(()=>G=W(f,"",G,{width:e()+"px",height:i()+"px"})),A5(2,f,()=>I5),A5(1,f,()=>I5),N(r,f)};u(v5,r=>{M.showHints&&k().includes(M.context)&&r(X5)})}var w5=E(v5,2);let c5;var M5=R(w5);let _5;var K5=E(M5,2);let m5;return I(w5),I(_),x3(_,r=>x=r,()=>x),i5(()=>{k5=W(_,y(),k5,{width:e()+"px",height:i()+"px"}),c5=W(w5,"",c5,{left:(e()-Q())/2+"px",top:(i()-Q())/2+"px"}),_5=W(M5,"",_5,{width:Q()+"px",height:Q()+"px",background:l(),opacity:o5(P),transition:"none",border:w()>0?w()+"px solid "+a():0}),m5=W(K5,"",m5,{left:g()[0]*h+"px",top:g()[1]*h+"px","margin-top":h/2+"px","margin-left":h/2+"px",transition:"opacity 0.2s ease-in-out",width:h+"px",height:h+"px",background:l(),opacity:o5(P),border:w()>0?w()+"px solid "+a():0})}),y5("pointerleave",_,()=>{c?.activateGamepad()}),N(L,_),H5(V5)}l5(["keydown","click","pointerdown","pointerup","pointermove","touchstart","touchend","pointerout"]);l5(["pointerdown"]);export{e5 as G,T as I,P1 as J,E3 as a,B5 as b,M as c,q as d,T1 as e,I5 as f,E1 as g,R5 as h,c3 as l,T3 as r,A5 as t,P3 as u};

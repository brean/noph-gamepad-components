...
</svg>`;var b1=B('<div class="svg-container svelte-8rvg2f"><!></div>');function T(L,t){z5(t,!0);let n=v(t,"width",3,40),s=v(t,"height",3,40),e=v(t,"color",3,"#666666");const i={0:p4,1:x4,2:f4,3:k4,4:v4,5:c4,6:M4,7:_4,8:m4,9:u4,10:y4,11:b4,12:E4,13:T4,14:P4,15:A4,16:C4,dpad_horizontal:R4,dpad_vertical:I4,left_axis:N4,left_horizontal:q4,left_vertical:O4,left_up:H4,left_right:G4,left_left:D4,left_down:z4,right_axis:S4,right_horizontal:B4,right_vertical:U4,right_up:V4,right_right:K4,right_left:X4,right_down:W4},l={0:j4,1:Y4,2:J4,3:Z4,4:$4,5:t1,6:n1,7:L1,8:s1,9:Q1,10:e1,11:i1,12:o1,13:l1,14:w1,15:g1,dpad_horizontal:r1,dpad_vertical:h1,left_axis:a1,left_horizontal:F1,left_vertical:d1,left_up:p1,left_right:x1,left_left:f1,left_down:k1,right_axis:v1,right_horizontal:c1,right_vertical:M1,right_up:_1,right_right:m1,right_left:u1,right_down:y1},a={any:W3,"/":j3,"*":Y3,",":J3,".":Z3,":":$3,";":t2,"[":n2,"]":L2,"+":s2,"-":Q2,"~":e2," ":i2,'"':o2,backspace:l2,capslock:w2,tab:g2,shift:r2,arrowleft:h2,arrowright:a2,arrowup:F2,arrowdown:d2,pagedown:p2,pageup:x2,end:f2,home:k2,control:v2,enter:c2,a:M2,b:_2,c:m2,d:u2,e:y2,f:b2,g:E2,h:T2,i:P2,j:A2,k:C2,l:R2,m:I2,n:N2,o:q2,p:O2,q:H2,r:G2,s:D2,t:z2,u:S2,v:B2,w:U2,x:V2,y:K2,z:X2,0:W2,1:j2,2:Y2,3:J2,4:Z2,5:$2,6:t4,7:n4,8:L4,9:s4,f1:Q4,f2:e4,f3:i4,f4:o4,f5:l4,f6:w4,f7:g4,f8:r4,f9:h4,f10:a4,f11:F4,f12:d4},F={0:U3,1:V3,2:K3,3:X3};let w=B5(void 0),c=t.type;switch(["ps4","ps5"].includes(t.type)&&(c="ps"),c){case"keyboard_mouse":let k=t.input.toLowerCase();N(w,a[k],!0);break;case"xbox":N(w,l[t.input],!0);break;case"ps":N(w,i[t.input],!0);break;case"generic":t.input in F?N(w,F[t.input],!0):N(w,i[t.input],!0)}var f=m3(),d=n5(f);{var Q=k=>{var h=b1();let g;var y=C(h);T3(y,()=>I(w).replace("<g>",`<g transform="scale(${Math.min(n()/64,s()/64)})">`).replace('fill="#FFFFFF"',`fill="${e()}"`)),R(h),i5(()=>g=K(h,"",g,{height:`${s()??""}px`,width:`${n()??""}px`})),G(k,h)};b(d,k=>{I(w)&&k(Q)})}G(L,f),S5()}l5(["pointerdown","click","pointerup","pointerout"]);l5(["keydown","click","pointerup","touchstart","touchend","pointerout","pointerdown"]);var E1=B('<div class="hint hint-up svelte-tppe42"><!> <!></div> <div class="hint hint-down svelte-tppe42"><!> <!></div>',1),T1=B("<!> <br/>",1),P1=B("<!> <br/>",1),A1=B('<div class="hint hint-left svelte-tppe42"><!> <!></div> <div class="hint hint-right svelte-tppe42"><!> <!></div>',1),C1=B('<div class="hints_container svelte-tppe42"><div class="hint svelte-tppe42"><!></div> <!> <!></div>'),R1=B('<div class="joystick_area svelte-tppe42" role="button"><!> <div class="joystick_container svelte-tppe42"><div class="joystick_back svelte-tppe42"></div> <div class="joystick_front svelte-tppe42"></div></div></div>');function D1(L,t){z5(t,!0);let n=v(t,"disabled",3,!1),s=v(t,"size",3,100),e=v(t,"backgroundWidth",3,200),i=v(t,"backgroundHeight",3,200),l=v(t,"color",3,"rgb(106, 191, 163)"),a=v(t,"defaultOpacity",3,.5),F=v(t,"activeOpacity",3,.8),w=v(t,"border",3,1),c=v(t,"borderColor",3,"black"),f=v(t,"position",31,()=>k5([0,0])),d=v(t,"style",3,"background-color: rgb(215, 219, 221);"),Q=v(t,"inputMapping",19,()=>({name:"Virtual Joystick",gamepad:-1,axes_x:0,axes_y:1,button_x_pos:[e5.DPAD_RIGHT],button_x_neg:[e5.DPAD_LEFT],button_y_pos:[e5.DPAD_DOWN],button_y_neg:[e5.DPAD_UP],deadzoneX:.05,deadzoneY:.05,key_x_pos:["d"],key_x_neg:["a"],key_y_pos:["s"],key_y_neg:["w"],invert_x:!1,invert_y:!1})),k=v(t,"context",19,()=>["default"]),h=v(t,"requiresFocus",3,!1);const g=s()/2;let y=!1,p,M,P=B5(k5(a()));function L5(){return p}function U(r){if(n()||!Q().gamepad||!y||!r.target)return;const x=r.target.getBoundingClientRect(),O=r.x-x.x,A=r.y-x.y;M&&(M.gamepadActive=!1,s5(O,A))}function s5(r,x){let O=r-e()/2,A=x-i()/2;X(O,A)}function X(r,x){Q().disable_axes&&(Q().disable_axes.includes("x")&&(r=0),Q().disable_axes.includes("y")&&(x=0));const O=I3(r,x),A=N3(r,x);let g5=O3(O,g),Q5=q3(g5,A),D=Q5[0]/g,z=Q5[1]/g;if(Math.abs(D)<Q().deadzoneX&&Math.abs(z)<Q().deadzoneY){f([0,0]),N(P,a());return}D=Math.abs(D)<1e-6?0:D,z=Math.abs(z)<1e-6?0:z,N(P,F()),f([D,z])}function V(){y=!1,N(P,a()),f([0,0])}function W5(r,x){N(P,r?F():a(),!0),Q().disable_axes&&(Q().disable_axes.includes("x")&&(x[0]=0),Q().disable_axes.includes("y")&&(x[1]=0)),f(x)}u3(()=>(G5(()=>{M=new S3(Q(),g,X,W5,p,h()),G3(k(),M)}),()=>{M&&D3(k(),M)}));var j5={getElement:L5},_=R1();C5("pointerup",y3,V),E3(_,"tabindex",0);let c5;var M5=C(_);{var Y5=r=>{var x=C1();let O;var A=C(x),g5=C(A);{var Q5=m=>{T(m,{type:"generic",input:"left_axis"})},D=t5(()=>[0,1].includes(Q().axes_x)&&[0,1].includes(Q().axes_y)),z=m=>{T(m,{type:"generic",input:"right_axis"})},$5=t5(()=>[2,3].includes(Q().axes_x)&&[2,3].includes(Q().axes_y));b(g5,m=>{I(D)?m(Q5):I($5)&&m(z,1)})}R(A);var b5=E(A,2);{var t3=m=>{var W=E1(),S=n5(W),j=C(S);{var r5=o=>{T(o,{type:"keyboard_mouse",get input(){return Q().key_y_neg[0]}})};b(j,o=>{Q().key_y_neg.length>0&&o(r5)})}var h5=E(j,2);{var a5=o=>{T(o,{type:"generic",get input(){return Q().button_y_neg[0]}})};b(h5,o=>{Q().button_y_neg.length>0&&o(a5)})}R(S);var Y=E(S,2),J=C(Y);{var F5=o=>{T(o,{type:"keyboard_mouse",get input(){return Q().key_y_pos[0]}})};b(J,o=>{Q().key_y_pos.length>0&&o(F5)})}var d5=E(J,2);{var p5=o=>{T(o,{type:"generic",get input(){return Q().button_y_pos[0]}})};b(d5,o=>{Q().button_y_pos.length>0&&o(p5)})}R(Y),G(m,W)},n3=t5(()=>!Q().disable_axes?.includes("y"));b(b5,m=>{I(n3)&&m(t3)})}var L3=E(b5,2);{var s3=m=>{var W=A1(),S=n5(W),j=C(S);{var r5=o=>{var Z=T1(),x5=n5(Z);T(x5,{type:"keyboard_mouse",get input(){return Q().key_x_neg[0]}}),R5(2),G(o,Z)};b(j,o=>{Q().key_x_neg.length>0&&o(r5)})}var h5=E(j,2);{var a5=o=>{T(o,{type:"generic",get input(){return Q().button_x_neg[0]}})};b(h5,o=>{Q().button_x_neg.length>0&&o(a5)})}R(S);var Y=E(S,2),J=C(Y);{var F5=o=>{var Z=P1(),x5=n5(Z);T(x5,{type:"keyboard_mouse",get input(){return Q().key_x_pos[0]}}),R5(2),G(o,Z)};b(J,o=>{Q().key_x_pos.length>0&&o(F5)})}var d5=E(J,2);{var p5=o=>{T(o,{type:"generic",get input(){return Q().button_x_pos[0]}})};b(d5,o=>{Q().button_x_pos.length>0&&o(p5)})}R(Y),G(m,W)},Q3=t5(()=>!Q().disable_axes?.includes("x"));b(L3,m=>{I(Q3)&&m(s3)})}R(x),i5(()=>O=K(x,"",O,{width:e()+"px",height:i()+"px"})),N5(2,x,()=>O5),N5(1,x,()=>O5),G(r,x)},J5=t5(()=>u.showHints&&k().includes(u.context));b(M5,r=>{I(J5)&&r(Y5)})}var w5=E(M5,2);let _5;var m5=C(w5);let u5;var Z5=E(m5,2);let y5;return R(w5),R(_),b3(_,r=>p=r,()=>p),i5(()=>{c5=K(_,d(),c5,{width:e()+"px",height:i()+"px"}),_5=K(w5,"",_5,{left:(e()-s())/2+"px",top:(i()-s())/2+"px"}),u5=K(m5,"",u5,{width:s()+"px",height:s()+"px",background:l(),opacity:I(P),transition:"none",border:w()>0?w()+"px solid "+c():0}),y5=K(Z5,"",y5,{left:f()[0]*g+"px",top:f()[1]*g+"px","margin-top":g/2+"px","margin-left":g/2+"px",transition:"opacity 0.2s ease-in-out",width:g+"px",height:g+"px",background:l(),opacity:I(P),border:w()>0?w()+"px solid "+c():0})}),H("keydown",_,()=>{p.focus()}),H("click",_,()=>{p.focus()}),H("pointerdown",_,r=>{n()||(r.stopImmediatePropagation(),y=!0,U(r))}),H("pointerup",_,()=>{M?.activateGamepad()}),C5("pointerleave",_,()=>{M?.activateGamepad()}),H("pointermove",_,U),H("touchstart",_,()=>{}),H("touchend",_,()=>{M?.activateGamepad()}),H("pointerout",_,()=>{M?.activateGamepad()}),G(L,_),S5(j5)}l5(["keydown","click","pointerdown","pointerup","pointermove","touchstart","touchend","pointerout"]);l5(["pointerdown"]);export{e5 as G,T as I,D1 as J,H3 as a,V5 as b,u as c,q5 as d,q as e,O5 as f,G1 as g,H1 as h,A3 as l,G3 as r,N5 as t,D3 as u};

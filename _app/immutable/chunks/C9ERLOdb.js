...
</svg>`;var y1=B('<div class="svg-container svelte-8rvg2f"><!></div>');function T(L,t){D5(t,!0);let n=v(t,"width",3,40),Q=v(t,"height",3,40),e=v(t,"color",3,"#666666");const i={0:d4,1:p4,2:x4,3:f4,4:k4,5:v4,6:c4,7:M4,8:_4,9:m4,10:u4,11:y4,12:b4,13:E4,14:T4,15:P4,16:A4,dpad_horizontal:C4,dpad_vertical:R4,left_axis:I4,left_horizontal:N4,left_vertical:O4,left_up:q4,left_right:H4,left_left:G4,left_down:D4,right_axis:z4,right_horizontal:S4,right_vertical:B4,right_up:U4,right_right:V4,right_left:X4,right_down:K4},l={0:W4,1:j4,2:Y4,3:J4,4:Z4,5:$4,6:t1,7:n1,8:L1,9:Q1,10:s1,11:e1,12:i1,13:o1,14:l1,15:w1,dpad_horizontal:g1,dpad_vertical:r1,left_axis:h1,left_horizontal:a1,left_vertical:F1,left_up:d1,left_right:p1,left_left:x1,left_down:f1,right_axis:k1,right_horizontal:v1,right_vertical:c1,right_up:M1,right_right:_1,right_left:m1,right_down:u1},a={any:K3,"/":W3,"*":j3,",":Y3,".":J3,":":Z3,";":$3,"[":t2,"]":n2,"+":L2,"-":Q2,"~":s2," ":e2,'"':i2,backspace:o2,capslock:l2,tab:w2,shift:g2,arrowleft:r2,arrowright:h2,arrowup:a2,arrowdown:F2,pagedown:d2,pageup:p2,end:x2,home:f2,control:k2,enter:v2,a:c2,b:M2,c:_2,d:m2,e:u2,f:y2,g:b2,h:E2,i:T2,j:P2,k:A2,l:C2,m:R2,n:I2,o:N2,p:O2,q:q2,r:H2,s:G2,t:D2,u:z2,v:S2,w:B2,x:U2,y:V2,z:X2,0:K2,1:W2,2:j2,3:Y2,4:J2,5:Z2,6:$2,7:t4,8:n4,9:L4,f1:Q4,f2:s4,f3:e4,f4:i4,f5:o4,f6:l4,f7:w4,f8:g4,f9:r4,f10:h4,f11:a4,f12:F4},F={0:B3,1:U3,2:V3,3:X3};let w=S5(void 0),c=t.type;switch(["ps4","ps5"].includes(t.type)&&(c="ps"),c){case"keyboard_mouse":let k=t.input.toLowerCase();N(w,a[k],!0);break;case"xbox":N(w,l[t.input],!0);break;case"ps":N(w,i[t.input],!0);break;case"generic":t.input in F?N(w,F[t.input],!0):N(w,i[t.input],!0)}var f=s3(),d=n5(f);{var s=k=>{var h=y1();let g;var y=C(h);E3(y,()=>I(w).replace("<g>",`<g transform="scale(${Math.min(n()/64,Q()/64)})">`).replace('fill="#FFFFFF"',`fill="${e()}"`)),R(h),i5(()=>g=X(h,"",g,{height:`${Q()??""}px`,width:`${n()??""}px`})),G(k,h)};b(d,k=>{I(w)&&k(s)})}G(L,f),z5()}l5(["pointerdown","click","pointerup","pointerout"]);l5(["keydown","click","pointerup","touchstart","touchend","pointerout","pointerdown"]);var b1=B('<div class="hint hint-up svelte-tppe42"><!> <!></div> <div class="hint hint-down svelte-tppe42"><!> <!></div>',1),E1=B("<!> <br/>",1),T1=B("<!> <br/>",1),P1=B('<div class="hint hint-left svelte-tppe42"><!> <!></div> <div class="hint hint-right svelte-tppe42"><!> <!></div>',1),A1=B('<div class="hints_container svelte-tppe42"><div class="hint svelte-tppe42"><!></div> <!> <!></div>'),C1=B('<div class="joystick_area svelte-tppe42" role="button"><!> <div class="joystick_container svelte-tppe42"><div class="joystick_back svelte-tppe42"></div> <div class="joystick_front svelte-tppe42"></div></div></div>');function G1(L,t){D5(t,!0);let n=v(t,"disabled",3,!1),Q=v(t,"size",3,100),e=v(t,"backgroundWidth",3,200),i=v(t,"backgroundHeight",3,200),l=v(t,"color",3,"rgb(106, 191, 163)"),a=v(t,"defaultOpacity",3,.5),F=v(t,"activeOpacity",3,.8),w=v(t,"border",3,1),c=v(t,"borderColor",3,"black"),f=v(t,"position",31,()=>k5([0,0])),d=v(t,"style",3,"background-color: rgb(215, 219, 221);"),s=v(t,"inputMapping",19,()=>({name:"Virtual Joystick",gamepad:-1,axes_x:0,axes_y:1,button_x_pos:[e5.DPAD_RIGHT],button_x_neg:[e5.DPAD_LEFT],button_y_pos:[e5.DPAD_DOWN],button_y_neg:[e5.DPAD_UP],deadzoneX:.05,deadzoneY:.05,key_x_pos:["d"],key_x_neg:["a"],key_y_pos:["s"],key_y_neg:["w"],invert_x:!1,invert_y:!1})),k=v(t,"context",19,()=>["default"]),h=v(t,"requiresFocus",3,!1);const g=Q()/2;let y=!1,p,M,P=S5(k5(a()));function L5(){return p}function U(r){if(n()||!s().gamepad||!y||!r.target)return;const x=r.target.getBoundingClientRect(),q=r.x-x.x,A=r.y-x.y;M&&(M.gamepadActive=!1,Q5(q,A))}function Q5(r,x){let q=r-e()/2,A=x-i()/2;K(q,A)}function K(r,x){s().disable_axes&&(s().disable_axes.includes("x")&&(r=0),s().disable_axes.includes("y")&&(x=0));const q=R3(r,x),A=I3(r,x);let g5=O3(q,g),s5=N3(g5,A),D=s5[0]/g,z=s5[1]/g;if(Math.abs(D)<s().deadzoneX&&Math.abs(z)<s().deadzoneY){f([0,0]),N(P,a());return}D=Math.abs(D)<1e-6?0:D,z=Math.abs(z)<1e-6?0:z,N(P,F()),f([D,z])}function V(){y=!1,N(P,a()),f([0,0])}function X5(r,x){N(P,r?F():a(),!0),s().disable_axes&&(s().disable_axes.includes("x")&&(x[0]=0),s().disable_axes.includes("y")&&(x[1]=0)),f(x)}m3(()=>(M=new z3(s(),g,K,X5,p,h()),H3(k(),M),()=>{M&&G3(k(),M)}));var K5={getElement:L5},m=C1();T5("pointerup",u3,V),b3(m,"tabindex",0);let c5;var M5=C(m);{var W5=r=>{var x=A1();let q;var A=C(x),g5=C(A);{var s5=u=>{T(u,{type:"generic",input:"left_axis"})},D=t5(()=>[0,1].includes(s().axes_x)&&[0,1].includes(s().axes_y)),z=u=>{T(u,{type:"generic",input:"right_axis"})},J5=t5(()=>[2,3].includes(s().axes_x)&&[2,3].includes(s().axes_y));b(g5,u=>{I(D)?u(s5):I(J5)&&u(z,1)})}R(A);var b5=E(A,2);{var Z5=u=>{var W=b1(),S=n5(W),j=C(S);{var r5=o=>{T(o,{type:"keyboard_mouse",get input(){return s().key_y_neg[0]}})};b(j,o=>{s().key_y_neg.length>0&&o(r5)})}var h5=E(j,2);{var a5=o=>{T(o,{type:"generic",get input(){return s().button_y_neg[0]}})};b(h5,o=>{s().button_y_neg.length>0&&o(a5)})}R(S);var Y=E(S,2),J=C(Y);{var F5=o=>{T(o,{type:"keyboard_mouse",get input(){return s().key_y_pos[0]}})};b(J,o=>{s().key_y_pos.length>0&&o(F5)})}var d5=E(J,2);{var p5=o=>{T(o,{type:"generic",get input(){return s().button_y_pos[0]}})};b(d5,o=>{s().button_y_pos.length>0&&o(p5)})}R(Y),G(u,W)},$5=t5(()=>!s().disable_axes?.includes("y"));b(b5,u=>{I($5)&&u(Z5)})}var t3=E(b5,2);{var n3=u=>{var W=P1(),S=n5(W),j=C(S);{var r5=o=>{var Z=E1(),x5=n5(Z);T(x5,{type:"keyboard_mouse",get input(){return s().key_x_neg[0]}}),R5(2),G(o,Z)};b(j,o=>{s().key_x_neg.length>0&&o(r5)})}var h5=E(j,2);{var a5=o=>{T(o,{type:"generic",get input(){return s().button_x_neg[0]}})};b(h5,o=>{s().button_x_neg.length>0&&o(a5)})}R(S);var Y=E(S,2),J=C(Y);{var F5=o=>{var Z=T1(),x5=n5(Z);T(x5,{type:"keyboard_mouse",get input(){return s().key_x_pos[0]}}),R5(2),G(o,Z)};b(J,o=>{s().key_x_pos.length>0&&o(F5)})}var d5=E(J,2);{var p5=o=>{T(o,{type:"generic",get input(){return s().button_x_pos[0]}})};b(d5,o=>{s().button_x_pos.length>0&&o(p5)})}R(Y),G(u,W)},L3=t5(()=>!s().disable_axes?.includes("x"));b(t3,u=>{I(L3)&&u(n3)})}R(x),i5(()=>q=X(x,"",q,{width:e()+"px",height:i()+"px"})),N5(2,x,()=>q5),N5(1,x,()=>q5),G(r,x)},j5=t5(()=>_.showHints&&k().includes(_.context));b(M5,r=>{I(j5)&&r(W5)})}var w5=E(M5,2);let _5;var m5=C(w5);let u5;var Y5=E(m5,2);let y5;return R(w5),R(m),y3(m,r=>p=r,()=>p),i5(()=>{c5=X(m,d(),c5,{width:e()+"px",height:i()+"px"}),_5=X(w5,"",_5,{left:(e()-Q())/2+"px",top:(i()-Q())/2+"px"}),u5=X(m5,"",u5,{width:Q()+"px",height:Q()+"px",background:l(),opacity:I(P),transition:"none",border:w()>0?w()+"px solid "+c():0}),y5=X(Y5,"",y5,{left:f()[0]*g+"px",top:f()[1]*g+"px","margin-top":g/2+"px","margin-left":g/2+"px",transition:"opacity 0.2s ease-in-out",width:g+"px",height:g+"px",background:l(),opacity:I(P),border:w()>0?w()+"px solid "+c():0})}),H("keydown",m,()=>{p.focus()}),H("click",m,()=>{p.focus()}),H("pointerdown",m,r=>{n()||(r.stopImmediatePropagation(),y=!0,U(r))}),H("pointerup",m,()=>{M?.activateGamepad()}),T5("pointerleave",m,()=>{M?.activateGamepad()}),H("pointermove",m,U),H("touchstart",m,()=>{}),H("touchend",m,()=>{M?.activateGamepad()}),H("pointerout",m,()=>{M?.activateGamepad()}),G(L,m),z5(K5)}l5(["keydown","click","pointerdown","pointerup","pointermove","touchstart","touchend","pointerout"]);l5(["pointerdown"]);export{e5 as G,T as I,G1 as J,q3 as a,U5 as b,_ as c,O as d,H1 as e,q5 as f,q1 as g,O5 as h,P3 as l,H3 as r,N5 as t,G3 as u};
